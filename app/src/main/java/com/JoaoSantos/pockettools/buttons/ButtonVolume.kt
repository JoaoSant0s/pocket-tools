...
class ButtonVolume(view: MainActivity) : Button{
    ...
    override fun create() : ViewGroup {
        ...
        val lowerButton = ButtonWrapper.createTextButton(context,  ButtonWrapper.horizontalElementLayoutParams, R.string.decrease_volume_button){
        ...
        val raiseButton = ButtonWrapper.createTextButton(context, ButtonWrapper.horizontalElementLayoutParams, R.string.increase_volume_button) {
